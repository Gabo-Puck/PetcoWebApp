...
$(window).on("load", () => {
  ...
  document.querySelectorAll(".agregarRespuesta").forEach((element) => {
    element.remove();
  });
  document.querySelectorAll("input[type='checkbox']").forEach((element) => {
    element.disabled = true;
  });
  document.querySelector("#eliminarEsteMenu").remove();
  document.querySelector("#borrarBotonGuardar").remove();
});
import {
  addPregunta,
  selectParent,
